...
/local/www/services/ProQ2/apps/sspro4/script/predict_ssa.pl /local/www/services/ProQ2/apps/sspro4/blast2.2.8/ /local/www/services/ProQ2/apps/sspro4/data/big/big_98_X /local/www/services/ProQ2/apps/sspro4/data/nr/nr /local/www/services/ProQ2/apps/sspro4/server/predict_seq_ss.sh /local/www/services/ProQ2/apps/sspro4/script/ $1 $2 
