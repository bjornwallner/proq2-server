...
my $SVM_MODEL_DIR="/scratch/DB/ProQ2/data/"; #/afs/pdc.kth.se/home/b/bjornw/CASP9/apps/ProQ2/data/";
if(!-e  $SVM_MODEL_DIR) {
    $SVM_MODEL_DIR="/afs/pdc.kth.se/home/b/bjornw/CASP9/apps/ProQ2/data/";
}
...
`/afs/pdc.kth.se/home/b/bjornw/CASP9/apps/ProQ2/bin/run_all_external2.pl $pdb $overwrite`;# -overwrite`;
